...
public class UserInterface {
    ...
    public static UserCredentials findOutUserCredentials(String[] args) {
        UserCredentialsOrganizer.checkNumberOfArguments(args.length);
        try {
            UserCredentials userCredentials = UserCredentialsOrganizer.fillCredentials(args);
            UserCredentialsOrganizer.checkForBlankCredentials(userCredentials);
    ...
    private static class UserCredentialsOrganizer {
    ...
    private static class BankAccountPrinter {
